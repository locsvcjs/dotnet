...
downloadspage=$(wget -qO - https://dotnet.microsoft.com/en-us/download/$dotnettype/$dotnetver)
...
wget -O /home/pi/dotnetdebug.sh https://raw.githubusercontent.com/locsvcjs/dotnet/main/debug.sh
...
echo ""
echo -e "\e[0mNow run \e[1mdotnet new console \e[0min a new directory!"
echo ""
echo -e "\e[1m----------------------------------------"
echo -e "\e[0m"
